...
import { Wrench, Search, Plus, Upload } from 'lucide-react'
...
function ServicesPage() {
  ...
  const {
    ...
    queryFn: () => apiGet<CatalogItem[]>(`/services?${params}`, opts),
    ...
    return (
      <div className="w-full">
        ...
        <p className="text-[var(--foreground-muted)]">
          Sign in and select a tenant to manage the services catalog.
        </p>
      </div>
    )
  }
      ...
      {isLoading ? (
        ...
        <Empty className="border border-[var(--border)] rounded-lg py-8 shadow-none mt-2">
          <EmptyHeader>
            ...
            <EmptyDescription>
              No services match your search. Add one or bulk upload.
            </EmptyDescription>
          </EmptyHeader>
          <EmptyContent>
            <Button
    ...
    <Dialog open={open} onOpenChange={handleClose}>
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          ...
          <DialogDescription>Add a service to the catalog.</DialogDescription>
        </DialogHeader>
        <form
          onSubmit={(e) => {
            e.preventDefault()
        ...
        >
          <div>
            <label htmlFor="svc-name" className="block text-sm text-[var(--foreground-muted)] mb-1">
              Name *
            </label>
            <input
              id="svc-name"
          ...
          <div>
            <label htmlFor="svc-code" className="block text-sm text-[var(--foreground-muted)] mb-1">
              Code
            </label>
            <input
              id="svc-code"
          ...
          <div>
            <label htmlFor="svc-remarks" className="block text-sm text-[var(--foreground-muted)] mb-1">
              Remarks
            </label>
            <input
              id="svc-remarks"
...
function BulkUploadServicesDialog({
  open,
  onOpenChange,
  onSuccess,
}: {
      ...
      <DialogContent className="sm:max-w-lg">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <textarea
            ...
            rows={8}
            placeholder='[{"name":"Consultation","code":"CON01"}]'
